...
echo "//========================================================================================//"
echo ""
echo "Running load test on /api/check_username endpoint."
echo ""
...
echo "//========================================================================================//"
echo ""
echo "Running load test on /api/login endpoint."
echo ""
...
echo "//========================================================================================//"
echo ""
echo "Running load test on /api/update_uo endpoint."
echo ""
...
echo "//========================================================================================//"
echo ""
echo "Running load test on /api/q/request_block endpoint."
echo ""
...
echo "//========================================================================================//"
echo ""
echo "Running load test on /api/top_ten_q endpoint."
echo ""
echo "# of concurrent connections: 10"
echo "# of requests per second:    500"
echo "Total runtime for this test: 20s"
echo "Type of request:             GET"
echo ""
echo "//========================================================================================//"

loadtest -c 10 -t 20 --rps 500 -k http://34.216.143.255:3002/api/top_ten_q
